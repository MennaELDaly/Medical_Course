                ...
                <div class="row">
                    <div class="header col-7">
                        ...
                        <nav class="nav">
                            ...
                            <a class="nav-link active" aria-current="page" href="/aboutus">من نحن</a>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-6 text">
                        <h1>اختر
                            <span>12000 </span>  
                             دورة عبر الإنترنت تنشر كل شهر</h1>
                        <p>يقوم مولّدنا هذا باستخدام كلمات من قاموس يحوي على أكثر من 200 كلمة
                            لاتينية، مضاف إليها مجموعة من الجمل النموذجية، لتكوين نص لوريم إيبسوم
                            ذو شكل منطقي قريب إلى النص الحقيقي. وبالتالي يكون النص الناتح خالي من
                            التكرار، أو أي كلمات أو عبارات غير لائقة أو ما شابه </p>
                            <p>هنالك العديد من الأنواع المتوفرة لنصوص لوريم إيبسوم، ولكن الغالبية تم
                                تعديلها بشكل ما عبر إدخال بعض النوادر</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-6 text box">
                    ...
                    <ul>
                        ...
                        <li> <i class="fas fa-check"></i>
                            مجموعة من الجمل النموذجية، لتكوين نص
                        </li>
                        <li> <i class="fas fa-check"></i>
                            مضاف إليها مجموعة من الجمل النموذجية، لتكوين نص لوريم إيبسوم 
                            <br>
                            <span> ذو شكل منطقي قريب إلى النص الحقيقي </span> 
                        </li>
                    </ul>
                </div>
                <div class="col-6 img">
